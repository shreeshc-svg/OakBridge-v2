...
TEMPLATE_COLUMNS = [
    ...
    ("category", "law | tax | academic | bgr | coffee-table | bespoke (required)"),
...
def _build_template_workbook() -> Workbook:
    ...
    instructions = [
        ...
        "3. Allowed values for `category`: law, tax, academic, bgr, coffee-table, bespoke. A value outside this list imports without error and then shows up under no category at all, so check the spelling.",
